...
COURSE_QUESTION_BANK = {
    ...
    "COSC208": [
        ...
        bank_question(
            ...
            "Search that explores every possible state",
            "Search guided by domain-specific knowledge to find solutions efficiently",
            "Search that requires no evaluation function",
            "Search limited to binary trees",
            "b",
            "Heuristic search uses rules of thumb to prune the search space and find near-optimal solutions.",
        ),
        bank_question(
            ...
            "Hill climbing",
            "b",
            "A* combines actual cost from start with heuristic estimate to goal for optimal pathfinding.",
        ),
        bank_question(
            "What is supervised machine learning?",
            "Learning without any labelled data",
            "Learning from labelled training data to map inputs to outputs",
            "Learning through trial and error with rewards",
            "Learning by clustering similar data points",
            "b",
            "Supervised learning trains models on input-output pairs to predict labels for new data.",
        ),
        bank_question(
            "What is an expert system?",
            "A system that learns from user feedback",
            "A program that uses a knowledge base and inference engine to solve complex problems",
            "A system that translates languages",
            "A database management tool",
            "b",
            "Expert systems emulate human expertise in a specific domain using rules and facts.",
        ),
        bank_question(
            "Which AI technique is inspired by neural structure of the human brain?",
            "Symbolic reasoning",
            "Genetic algorithms",
        ...
        bank_question(
            ...
            "b",
            "NLP bridges human communication and computer understanding through computational techniques.",
        ),
        bank_question(
            "What is the Turing test used for?",
            "Testing computer processing speed",
            "Determining whether a machine exhibits intelligent behaviour indistinguishable from a human",
            "Testing programming language syntax",
            "Measuring algorithm efficiency",
            "b",
            "The Turing test evaluates a machine's ability to exhibit human-like conversational intelligence.",
        ),
        bank_question(
            ...
            "b",
            "K-means groups similar data points without requiring labelled training data.",
        ),
        bank_question(
            "What does a genetic algorithm use to evolve solutions?",
            "Gradient descent",
            "Selection, crossover, and mutation",
            "Backpropagation",
            "Dynamic programming",
            "b",
            "Genetic algorithms apply evolutionary operators to populations of candidate solutions.",
        ),
        bank_question(
            "What is knowledge representation in AI?",
            "Storing data in databases",
            "Formal methods for encoding information about the world for reasoning systems",
            "Compressing data for storage",
            "Visualising data through charts",
            "b",
            "Knowledge representation provides structured ways to capture and reason about domain knowledge.",
        ),
        bank_question(
            "What is reinforcement learning?",
            "Learning from labelled datasets",
            "Learning by interacting with an environment and receiving rewards or penalties",
            "Learning by memorising all possible outcomes",
            "Learning through teacher supervision only",
            "b",
            "Reinforcement learning agents learn optimal behaviour through trial-and-error interaction.",
        ),
    ],
    "COSC212": [
        bank_question(
