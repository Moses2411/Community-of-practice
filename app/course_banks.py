...
COURSE_QUESTION_BANK = {
    ...
    "COSC208": [
        ...
        theory_question(
            "What is Artificial Intelligence and what are the main faculties involved with intelligent behaviour?",
        ...
        theory_question(
            "What are the four approaches to AI: acting humanly, thinking humanly, thinking rationally, and acting rationally?",
        ...
        theory_question(
            "What are the key milestones in the history of AI from its inception to modern times?",
        ...
        theory_question(
            "What is rationality in the context of intelligent agents and how does it differ from omniscience?",
        ...
        theory_question(
            "What is the difference between uninformed search and informed search, with two examples of each?",
        ...
        theory_question(
            "How does breadth-first search work and what are its data structure, completeness, optimality, and complexity characteristics?",
        ...
        theory_question(
            "How does depth-first search work and what are its data structure, completeness, optimality, and complexity characteristics?",
        ...
        theory_question(
            "How does the A* search algorithm work and what condition must the heuristic satisfy for optimality?",
        ...
        theory_question(
            "How does alpha-beta pruning improve the efficiency of minimax search without affecting the final result?",
        ...
        theory_question(
            "What four main features should a knowledge representation language possess?",
        ...
        theory_question(
            "What is the Classic language for knowledge representation and what enhancements does it offer?",
        ...
        theory_question(
            "How are programming languages like Lisp and Prolog suited for AI development?",
        ...
        theory_question(
            "What is word sense disambiguation and why is it a difficult problem in natural language processing?",
        ...
        theory_question(
            "What are the two main components of an expert system and what does each contain and do?",
        ...
        theory_question(
            "How does backward chaining work in expert systems and when is it most appropriately used?",
        ...
        theory_question(
            "How does the recognise-act cycle work in production rule systems?",
        ...
        theory_question(
            "What three types of problems can expert systems solve, with examples?",
        ...
        theory_question(
            "What is the role of robotics in AI and how do robots perceive and act upon their environment?",
        ...
        theory_question(
            "What are the limits of AI today as identified in the course material?",
    ...
    "COSC402": [
        ...
        theory_question('What is the difference between syntax and semantics in formal logic?'),
        theory_question('How is a natural deduction proof constructed for a simple formula?'),
        theory_question('What is soundness and why is it important for a logical calculus?'),
        theory_question('How does Hoare logic verify imperative program correctness?'),
        theory_question('What is Dijkstra\'s weakest precondition calculus and how does it differ from Hoare logic?'),
        theory_question('What is a loop invariant? Example for summing first n natural numbers.'),
        theory_question('What are the differences between propositional and predicate logic?'),
        theory_question('What are the natural deduction rules for conjunction?'),
        theory_question('What is the Curry-Howard correspondence?'),
        theory_question('How is mathematical induction used to prove properties of functional programs?'),
        theory_question('What is a predicate transformer? Give an example with assignment.'),
        theory_question('Why are Goedel\'s incompleteness theorems significant for formal methods?'),
        theory_question('What is the difference between partial and total correctness in program verification?'),
        theory_question('What are the Law of Excluded Middle and the Law of Non-Contradiction in classical logic?'),
        theory_question('What is formal specification vs informal requirements?'),
        theory_question('What role do types play in lambda calculus and how do they prevent inconsistencies?'),
        theory_question('How does structural induction work for proving properties of recursive data types?'),
        theory_question('What is the relationship between lambda calculus and Haskell functional programming?'),
        theory_question('What is a model in first-order logic and what does satisfiability mean?'),
        theory_question('What are the natural deduction rules for the universal quantifier?'),
        theory_question('What is the significance of sequent calculus compared to natural deduction?'),
        theory_question('How does the resolution principle work in automated theorem proving?'),
        theory_question('What are the differences between axiomatic, denotational, and operational semantics?'),
        theory_question('What is a well-founded ordering for proving termination?'),
        theory_question('What is bisimulation in state transition systems and why is it important?'),
        theory_question('How is temporal logic used for verifying reactive systems?'),
        theory_question('What role do type systems play in preventing runtime errors?'),
        theory_question('What is parametric polymorphism and how does it relate to logic?'),
        theory_question('What is the difference between model checking and deductive verification?'),
            ],
    "COSC403": [
        bank_question(
    ...
    "COSC404": [
        ...
        theory_question('What is the difference between physical and logical topology in network design?'),
        theory_question('What are the advantages and disadvantages of full mesh topology compared to star topology?'),
        theory_question('What is SNMP and what are its key components (manager, agent, MIB)?'),
        theory_question('What is the FCAPS model and what does each functional area cover?'),
        theory_question('How does scalability differ from network performance?'),
        theory_question('How would you design a scalable network for a company growing from 50 to 500 employees?'),
        theory_question('What is the relationship between throughput, bandwidth, and latency in a network?'),
        theory_question('How does a DoS attack impact network availability and what mitigations can be used?'),
        theory_question('What is the OSI model and what is the function of each of its seven layers?'),
        theory_question('What are the differences between a hub, a switch, and a router, and when should each be used?'),
        theory_question('How VLANs improve network management and security.'),
        theory_question('What are the security differences between SNMPv1, SNMPv2c, and SNMPv3?'),
        theory_question('What is network segmentation and why is it important?'),
        theory_question('What is a Service Level Agreement (SLA) and why is it important in network management?'),
        theory_question('What are the differences between OSPF and BGP in how they operate and when each is used?'),
        theory_question('What is the purpose of NAT and how does it help conserve IP address space?'),
        theory_question('What are the differences between stateful and stateless firewalls?'),
        theory_question('What are the key considerations when designing a campus wireless network?'),
        theory_question('What is the function of ARP in TCP/IP networks?'),
        theory_question('How DHCP automates network configuration.'),
        theory_question('What role does a DMZ play in enterprise network architecture?'),
        theory_question('What are the differences between circuit switching and packet switching?'),
        theory_question('How load balancers improve application availability.'),
        theory_question('How does Software-Defined Networking (SDN) differ from traditional networking?'),
        theory_question('What is the purpose of a VPN and how does it ensure secure communication?'),
        theory_question('What are the differences between symmetric and asymmetric encryption in network security?'),
        theory_question('What steps would you follow to troubleshoot network connectivity issues?'),
        theory_question('What are the key differences between IPv4 and IPv6 and why is IPv6 needed?'),
    ...
    "COSC406": [
        ...
        theory_question('What are the ACID properties in database transactions and why is each one important?'),
        theory_question('How does database normalisation work from 1NF to BCNF, with an example?'),
        theory_question('What is the difference between vertical and horizontal fragmentation in distributed databases?'),
        theory_question('How two-phase locking ensures serialisability.'),
        theory_question('What are the stages of the query processing pipeline from parsing to execution?'),
        theory_question('What are the differences between B-tree and B+ tree indexes and which is more commonly used?'),
        theory_question('What is Multi-Version Concurrency Control (MVCC) and how does it improve database performance?'),
        theory_question('What is the write-ahead logging protocol and what role does it play in crash recovery?'),
        theory_question('What are the trade-offs between optimistic and pessimistic concurrency control?'),
        theory_question('What is the CAP theorem and how does it apply to NoSQL database design?'),
        theory_question('What is the three-schema ANSI/SPARC database architecture?'),
        theory_question('What is a functional dependency and role in normalisation.'),
        theory_question('What are the performance implications of clustered versus non-clustered indexes?'),
        theory_question('How ARIES recovery algorithm works.'),
        theory_question('How can deadlocks be detected and prevented in a DBMS?'),
        theory_question('What are the differences between a materialised view and a regular view?'),
        theory_question('How does cost-based query optimisation work, with an example?'),
        theory_question('What is referential integrity and how is it enforced in a relational database?'),
        theory_question('What is a transaction schedule and what conditions make it serialisable?'),
        theory_question('What are the differences between SQL and NoSQL databases and when should each be used?'),
        theory_question('What are the differences between a data warehouse and an operational database?'),
        theory_question('What is the ETL process in data warehousing and what are its main stages?'),
        theory_question('How bitmap indexes work and when effective.'),
        theory_question('What are the differences between star schema and snowflake schema in dimensional modelling?'),
        theory_question('What is sharding and how does it work in distributed databases?'),
        theory_question('How are GRANT and REVOKE used for database security and access control?'),
        theory_question('What is the purpose of database replication and what are common replication strategies?'),
        theory_question('What is the phantom read anomaly and which isolation level prevents it?'),
        theory_question('How does relational algebra differ from SQL as a query language?'),
            ],
    "COSC407": [
        bank_question(
    ...
    "COSC408": [
        ...
        theory_question('What are the phases of a compiler and what is the input and output of each phase?'),
        theory_question('What are the differences between lexical analysis and syntax analysis, and why are they separate phases?'),
        theory_question('What are the differences between top-down and bottom-up parsing, with examples of each?'),
        theory_question('How do you eliminate left recursion from a context-free grammar, with an example?'),
        theory_question('What is the difference between an abstract syntax tree (AST) and a concrete parse tree?'),
        theory_question('What role does a symbol table play in compilation and how are nested scopes handled?'),
        theory_question('How LR parsing works with table and stack.'),
        theory_question('What is the difference between static and dynamic type checking?'),
        theory_question('What are the advantages of a compiler compared to an interpreter, and vice versa?'),
        theory_question('What is three-address code and why is it used as an intermediate representation in compilers?'),
        theory_question('What are the differences in parsing power between LL(1) and LR(1) parsers?'),
        theory_question('How is a recursive descent parser constructed and what restrictions does it have?'),
        theory_question('What are the different levels of code optimisation and what techniques are used at each level?'),
        theory_question('What roles do Flex and Bison play in compiler construction?'),
        theory_question('How FIRST and FOLLOW sets construct LL1 tables.'),
        theory_question('How does operator precedence parsing work for evaluating expressions?'),
        theory_question('What semantic analysis detects that syntax cannot.'),
        theory_question('How does register allocation work, including the graph colouring approach?'),
        theory_question('What are the differences between static and dynamic linking?'),
        theory_question('What is a JIT compiler and how does it combine compilation with interpretation?'),
        theory_question('How garbage collector interacts with generated code.'),
        theory_question('What is Static Single Assignment (SSA) form and what advantages does it offer for code optimisation?'),
        theory_question('What are the differences between a one-pass and a multi-pass compiler?'),
        theory_question('How is error recovery handled in different phases of a compiler?'),
        theory_question('How are function calls translated to assembly code by a compiler?'),
        theory_question('What is peephole optimisation and what kinds of improvements does it make?'),
        theory_question('What are the benefits and trade-offs of loop unrolling as an optimisation technique?'),
        theory_question('How do compilers handle function overloading and polymorphism?'),
        theory_question('What are the main challenges in designing a compiler for a new programming language?'),
            ],
    "COSC409": [
        bank_question(
    ...
    "COSC416": [
        ...
        theory_question('What is the difference between discrete-event simulation and continuous simulation, with examples of each?'),
        theory_question('What are the key components of a discrete-event simulation including entities, attributes, events, and activities?'),
        theory_question('What role does the Future Event List play in discrete-event simulation and how are events processed?'),
        theory_question('What is Little\'s Law and what is its significance in queuing analysis?'),
        theory_question('What are the steps involved in conducting a simulation study from formulation to implementation?'),
        theory_question('What is the difference between verification and validation in simulation, with examples?'),
        theory_question('How does the inverse transform method work for generating random variates?'),
        theory_question('What is the M/M/1 queuing model and what are its key assumptions?'),
        theory_question('What are the differences between terminating and steady-state simulation?'),
        theory_question('What properties make a pseudo-random number generator a good random number generator?'),
        theory_question('How would you simulate a single-server queue system step by step?'),
        theory_question('What are the differences between the Monte Carlo method and discrete-event simulation?'),
        theory_question('What are the differences between the event-scheduling and process-interaction world views in simulation?'),
        theory_question('What probability distributions are commonly used in simulation and when is each appropriate?'),
        theory_question('What is the purpose of input modelling in a simulation study?'),
        theory_question('How do you select an appropriate probability distribution for real-world simulation data?'),
        theory_question('How does the common random numbers technique reduce variance in simulation experiments?'),
        theory_question('How are inventory systems modelled using discrete-event simulation?'),
        theory_question('What are the differences between fixed-increment time advance and next-event time advance?'),
        theory_question('Why is a warm-up period needed in steady-state simulation and how is its length determined?'),
        theory_question('How is statistical output analysis performed in simulation studies?'),
        theory_question('How does the acceptance-rejection method work and when is it preferred over other methods?'),
        theory_question('How are confidence intervals constructed for simulation output data?'),
        theory_question('What goodness-of-fit tests can be used to select an appropriate input distribution?'),
        theory_question('What are the advantages and limitations of simulation compared to analytical models?'),
        theory_question('How is simulation applied to healthcare systems and what are some examples?'),
        theory_question('What categories of simulation software exist and how do simulation languages differ from simulation environments?'),
        theory_question('What is the purpose of experimental design in simulation studies?'),
        theory_question('What is the difference between delay, conditional wait, and activity in simulation?'),
            ],
}
